...
export const map_value_to_label_app_constant: Record<
  language_values_global_enum,
  language_labels_app_enum
> = {
  [language_values_global_enum.AR]: language_labels_app_enum.AR,
  [language_values_global_enum.EN]: language_labels_app_enum.EN,
  [language_values_global_enum.ES]: language_labels_app_enum.ES,
  [language_values_global_enum.RU]: language_labels_app_enum.RU,
  [language_values_global_enum.ZH]: language_labels_app_enum.ZH,
} as const;
